      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-8">
        ...
        >
          <div className="max-w-2xl text-center md:text-left mx-auto md:mx-0">
            <h2
              className={`${roxborough.className} text-3xl lg:text-4xl xl:text-5xl font-bold text-black tracking-tight leading-tight mb-4`}
            >
              Meet The <span className="italic font-light">Crafters</span>
            </h2>
            <p className="text-sm lg:text-lg text-black/70 font-light">
            ...
            <motion.div key={member.employeeId} variants={itemVariants}>
              <Dialog>
                <DialogTrigger className="group flex flex-col items-center sm:items-start sm:text-left w-full text-left outline-none cursor-pointer">
                  <div className="relative w-full max-w-70 sm:max-w-full aspect-4/5 rounded-2xl overflow-hidden mb-6 bg-black/5 border border-black/5">
                    <Image
                      src={member.avatar}
                  ...
                  <div className="flex flex-col gap-1 w-full px-2">
                    ...
                    <h3
                      className={`${roxborough.className} text-lg md:text-2xl font-bold text-black`}
                    >
                      {member.name}
                    </h3>
                    <p className="text-black/70 text-sm font-light mt-1">
                      {member.designation}
                    </p>
                  </div>
                </DialogTrigger>
                ...
                {/* Dialog Content */}
                <DialogContent className="w-[95vw] md:max-w-3xl lg:max-w-5xl xl:max-w-6xl bg-[#f1f2e1] border-none shadow-2xl p-0 rounded-3xl max-h-[95vh] overflow-y-auto overflow-x-hidden z-50">
                  ...
                  <div className="flex flex-col lg:flex-row w-full min-h-[60vh]">
                    ...
                    <div className="relative w-full lg:w-[40%] bg-black/5 shrink-0 min-h-80 lg:min-h-full">
                      <Image
                        src={member.avatar}
                        alt={`${member.name} - ${member.designation}`}
                        width={600}
                      ...
                      <div className="flex flex-col xl:flex-row justify-between gap-10 xl:gap-8 items-start w-full">
                        ...
                        <div className="flex flex-col gap-5 max-w-xl">
                          <div className="flex flex-col gap-2">
                            ...
                            <h3
                              className={`${roxborough.className} text-4xl md:text5xl font-bold text-black leading-none`}
                            >
                              {member.name}
                            </h3>
                            <p className="text-black/70 font-medium text-lg tracking-wide">
                              {member.designation}
                            </p>
                          </div>
                          ...
                          <p className="text-black/70 text-base md:text-md font-light leading-relaxed">
                            {member.bio}
                          </p>
                          ...
                          <div className="flex items-center gap-4 mt-4">
                            <a
                              ...
                              className="p-3.5 rounded-full bg-black/5 hover:bg-black/10 text-black hover:text-green-800 transition-colors cursor-pointer"
                            ...
                            <a
                              ...
                              className="p-3.5 rounded-full bg-black/5 hover:bg-black/10 hover:text-[#0a66c2] text-black transition-colors cursor-pointer"
                        ...
                        <div className="shrink-0 flex flex-col items-center xl:items-end w-full xl:w-auto">
                          ...
                          <span className="mt-6 text-xs text-black/50 text-center xl:text-right uppercase tracking-wider font-semibold">
